...
public partial class MacroTextEntry : Form
{
    ...
    private void ButtonAdd_Click(object sender, EventArgs e)
    {
        ...
        AddTextAtCaret(modifiedKeys);
    }

    private void AddTextAtCaret(string text)
    {
        int caret = textBox1.SelectionStart;
        textBox1.Text = textBox1.Text.Insert(caret, text);
        textBox1.SelectionStart = caret + text.Length;
    }

    private void buttonEnable_Click(object sender, EventArgs e)
    {
        AddTextAtCaret("{[enable:" + textBoxCategory.Text + "]}");
    }
